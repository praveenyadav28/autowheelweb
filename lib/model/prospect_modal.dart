...
//
//     final customerName = customerNameFromJson(jsonString);

List<CustomerName> customerNameFromJson(String str) => List<CustomerName>.from(json.decode(str).map((x) => CustomerName.fromJson(x)));

String customerNameToJson(List<CustomerName> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
